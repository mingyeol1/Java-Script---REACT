...
//만약 위 함수에 전달할 값 중에 b가 주어지지 않는 경우엔 undefiend
// b 값에는 undefine가 나온다.
...
//비구조화 할당에서 값의 이름은 할당에 중요한 역할을 한다. 즉 이름이 다르면 안된다.
//하지만 다름 이름으로 사용하고 싶으면
//   {key : 변경할 이름} > 키를 변경할 이름으로 선언하겠다는 의미.

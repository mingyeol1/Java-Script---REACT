...
console.log(dog.age);
//키에 해당하는 부분은 공백이 없어야한다.
//만약에 공백을 사용해야 하는 경우....''/""로 묶어준다.
const sample = {
    'key with space' : true
};
console.log(sample);
...
const dog2 = {
    ...
    sound: '멍멍!',
    say: function say(){
        console.log(this.sound); //this 는 dog2를 가르킨다.
    }
};
...
const dog3 = {
    ...
    sound: '멍멍!',
    say: () => {
        console.log(this.sound); // 타입에러가 나타난다. sound에 대한 undefined
    }
};
...
const numbers = {
    a: 1,
    b: 2,
    get sum() {     //Getter 함수 특정값을 조회시. 설정한 함수로 연산된 결과를 반환.
...
numbers2.b = 7;                    //setter 동작
numbers2.a = 9;                    //setter 동작

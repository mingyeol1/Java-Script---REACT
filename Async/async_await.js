// async /await : ES8에 해당하는 문법으로 Promise를  //즉 비동기를 동기화 처럼 만들어준다.
//      더욱 쉽게 사용할 수 있게 한다. 
...
//process1();
//---------------------------------------
//asyne는 함수의 앞부분에 사용하는 키워드 이다.
// await는 Promise 앞부분에 사용하는 키워드. 프로미스가 끝날 때 까지
    //기다렸다가 다음 작업을 수행.
